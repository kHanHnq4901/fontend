...
<div class="content">
	...
	@endif
            <div class="col-md-12">
                <h4 class="title">Lịch sử đóng tiền của sinh viên: BKC1000{{$id}} - {{$student->nameStudent}}  </h4>
                <br>
                        ...
                        <div class="fresh-datatables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">{{number_format($bill->feeBill) }}</th>
                                    <th class="text-center">{{$bill->note}}</th>
                                    <th class="text-center">{{$bill->created_at}}</th>
