...
<div class="content">
	...
	@endif
            <div class="col-md-12">
                <h4 class="title">Lịch sử đóng học phí của sinh viên:BKC1000{{$id}}</h4>
                <br>
                        ...
                        <div class="fresh-datatables">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Sô tiền nộp</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">{{number_format($bill->feeBill) }} VNĐ</th>
                                    <th class="text-center">{{$bill->note}}</th>
                                    <th class="text-center">{{ date('H:i:s d/m/Y', strtotime($bill->created_at))}}</th>
